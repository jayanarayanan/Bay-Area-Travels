...
//        dhandler.createTable();
        ...
        server.addHandlers("/sendLinkToDB", new AddLinkServlet());
        server.addHandlers("/viewLinks", new ViewLinksServlet());
        server.addHandlers("/clearLinks", new ClearLinksServlet());
        server.start();
